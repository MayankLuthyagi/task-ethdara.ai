            ...
            <div>
                {tasks.map((a) => (
                    <div key={a._id} style={{ border: '1px solid #ddd', padding: 8, margin: 8 }}>
                        ...
                        <div>Task Due: {a.task_id?.dueDate ? new Date(a.task_id.dueDate).toLocaleDateString() : '-'}</div>
                        <div>Assignment Deadline: {a.deadline ? new Date(a.deadline).toLocaleDateString() : '-'}</div>
